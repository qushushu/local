...
<template>
    <div class="ym-main">
        ...
        <a-card class="card-pd">
            ...
            <!-- 导出excel end -->
            <!-- 数据表格 start -->
            <el-table ref="multipleTable" :data="tableData" height="300" border  size="small" empty-text class="space-btm">
                <el-table-column size="small" v-for="item,key in colList" :key="key" :prop="item.prop" :label="item.label">
                    <template slot-scope="scope">
                        <div style="width: 100%;position: relative;">
                                <el-input v-model="scope.row[item.prop]" class="temp_nobd" placeholder="请输入内容" size="small" readonly>
                                    
                                </el-input>
                                <div style="position: absolute;right: 6px;z-index: 10;top: 6px;font-size: 16px;cursor: pointer;">
                                    <i class="el-icon-edit"></i>
                                    <!-- <i class="el-icon-check"></i> -->
                                </div>
                                <!-- <p>{{ scope.row[item.prop] }}<a href="javascript:;" style="color: #000;position: absolute;right: 0;"></a></p> -->
...
<style scoped>
    .temp_nobd {border: 1px solid rgba(0,0,0,0);}
    .temp_nobd >>> .el-input__inner {border: 1px solid rgba(0,0,0,0);}
</style>
<script>
